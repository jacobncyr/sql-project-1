...
--okay just to recap so I dont lose my place , you created new sales_report and 
...
```
```
--i can uncomment and iterate down the list of tables quickly with this code to check for distinct values
